(() => {
  ...
  const removePhoneDecorations = (link) => {
    ...
    // Preserve the two intentional direct children:
    // the branded SVG icon and the phone-number display span.
    ...
    // The number is generated by CSS; injected child content is unnecessary.
    if (display && (display.children.length || display.textContent.trim())) {
      display.replaceChildren();
    }

    // Some extensions append their badge immediately after the phone link.
